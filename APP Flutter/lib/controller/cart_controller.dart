...
class CartController extends GetxController implements GetxService {
  ...
  double calculationCart(){
    ...
    for (var cartModel in _cartList) {
      ...
      _itemDiscountPrice = _itemDiscountPrice + ((cartModel.price! - PriceConverter.convertWithDiscount(cartModel.price,
          cartModel.product!.restaurantDiscount! > 0 ? cartModel.product!.restaurantDiscount! : cartModel.product!.discount,
          cartModel.product!.restaurantDiscount! > 0 ? 'percent' : cartModel.product!.discountType)!) * cartModel.quantity!);
    }
