    ...
    return WillPopScope(
      ...
      child: GetBuilder<OrderController>(builder: (orderController) {
        ...
        return Scaffold(
            ...
            body: (order != null && orderController.orderDetails != null) ? Column(children: [
            ...
            Expanded(child: Scrollbar(child: SingleChildScrollView(
              ...
              child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                DateConverter.isBeforeTime(order.scheduleAt) ? (order.orderStatus != 'delivered' && order.orderStatus != 'failed'
                && !cancelled && order.orderStatus != 'refund_requested' && order.orderStatus != 'refunded'
                && order.orderStatus != 'refund_request_canceled' && !subscription) ? Column(children: [
                ...
                order.restaurant != null ? Row(children: [
                  ...
                  (showChatPermission && !delivered && order.orderStatus != 'failed' && !cancelled && order.orderStatus != 'refunded') ? TextButton.icon(
                    onPressed: () async {
                ...
                child: Padding(
                  ...
                  child: !orderController.isLoading ? Row(
                    children: [
                      ...
                      !subscription && (delivered || cancelled || order.orderStatus == 'failed' || order.orderStatus == 'refund_request_canceled')
                      ? Expanded(
                        child: CustomButton(
