...
class SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      Get.find<MySearchController.SearchController>().getSuggestedFoods();
    }
    Get.find<MySearchController.SearchController>().getHistoryList();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        if (Get.find<MySearchController.SearchController>().isSearchMode) {
          return true;
        } else {
          Get.find<MySearchController.SearchController>().setSearchMode(true);
          return false;
        }
      },
      child: Scaffold(
  ...
  void _actionSearch(
      MySearchController.SearchController searchController, bool isSubmit) {
