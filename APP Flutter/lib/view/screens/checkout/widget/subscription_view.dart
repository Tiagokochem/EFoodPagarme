              ...
              child: Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text(
                    ...
                    style: robotoRegular.copyWith(color: isSelected ? Colors.white : Colors.black),
                  ),
                  ...
                  isSelected ? Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: robotoRegular.copyWith(color: isSelected ? Colors.white : Colors.black, fontSize: Dimensions.fontSizeExtraSmall),
                  ) : const SizedBox(),
                ]),
              ),
            ),
