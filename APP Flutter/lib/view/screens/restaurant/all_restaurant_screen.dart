...
class _AllRestaurantScreenState extends State<AllRestaurantScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: widget.isPopular ? 'popular_restaurants'.tr : widget.isRecentlyViewed ? 'recently_viewed_restaurants'.tr : '${'new_on'.tr} ${AppConstants.appName}'),
