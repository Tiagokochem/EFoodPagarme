                      ...
                      builder: (walletController) {
                        return Column(children: [
                           ...
                           Stack(
                            children: [
                              Container(
                                padding: widget.fromWallet ? const EdgeInsets.all(Dimensions.paddingSizeOverLarge)
                                    : const EdgeInsets.only(top: 40, left: Dimensions.paddingSizeOverLarge, right: Dimensions.paddingSizeOverLarge),
