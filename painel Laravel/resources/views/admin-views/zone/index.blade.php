                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="minimum_delivery_charge" name="minimum_delivery_charge" required type="number" min=".001" step=".0001" class="form-control h--45px" placeholder="{{ translate('messages.Ex :') }} 10" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input id="delivery_charge_per_km" name="per_km_delivery_charge" required type="number" min=".001" step=".0001" class="form-control h--45px" placeholder="{{ translate('messages.Ex :') }} 10" >
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group mb-3">
