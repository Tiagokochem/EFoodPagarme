                        ...
                        <input type="hidden" name="lang[]" value="default">
                            @foreach(json_decode($language) as $lang)
                                ...
                                <div class="form-group d-none lang_form" id="{{$lang}}-form">
                                    ...
                                    <input type="text" name="name[]" class="form-control" placeholder="{{translate('messages.new_addon')}}" maxlength="191" value="{{$lang==$default_lang?$addon['name']:($translate[$lang]['name']??'')}}" oninvalid="document.getElementById('en-link').click()">
                                </div>
