                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]" class="form-control" placeholder="{{ translate('messages.restaurant') }} {{ translate('messages.name') }}" value="{{ $restaurant['name'] }}" required maxlength="191">
                                    </div>
